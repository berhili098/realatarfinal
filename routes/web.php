...
Route::middleware([ 'auth:sanctum','adminAuth',  config('jetstream.auth_session'), 'verified'])->group(function () {

    //USER

    Route::get('/admin/users',UsersComponent::class)->name('admin-users');
    Route::get('/admin/users/add',AddUser::class)->name('admin-adduser');
