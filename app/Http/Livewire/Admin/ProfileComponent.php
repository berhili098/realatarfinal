...
class ProfileComponent extends Component
{
    ...
    public function updatedNewphoto()
    {
        ...
        session()->flash('message', 'Well done, You have successfully updated your profile picture ');
    ...
    public function updateProfile()
    {
        ...
        session()->flash('type', 'info');
        session()->flash('message', 'Well done, You have successfully updated your profile   ');
        session()->flash('title', 'Operation success');
