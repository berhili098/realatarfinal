...
class EditCityComponent extends Component
{
    ...
    public function updateCity()
    {
        ...
        session()->flash('message', 'Well done, You have successfully updated city :  ' . $this->city_en);
         session()->flash('title', 'Operation success');
        // $this->dispatchBrowserEvent('contentChanged', ['item' => "City data has been updated successfully."]);
