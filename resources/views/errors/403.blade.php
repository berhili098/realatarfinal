...
<head>
    ...
    <title>ATAR - 404 Page not found</title>
    
    <!-- Custom CSS -->
    <link href="{{ asset('primary/dist/css/style.min.css') }}" rel="stylesheet">
    <!-- page css -->
    <link href="{{ asset('primary/dist/css/pages/error-pages.css') }}" rel="stylesheet">
...
<body class="skin-blue fixed-layout">
    ...
    <!--Wave Effects -->
    <script src="{{ asset('priamry/dist/js/waves.js') }}"></script>
</body>
