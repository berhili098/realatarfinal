            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <h4 class="m-b-0 text-white">Edit Quiz</h4>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form wire:submit.prevent="updateQuiz()">
                                                ...
                                                <div class="form-group has-info">
                                                    <select class="form-control custom-select" wire:model="site_id">
                                                        ...
                                                        @foreach ($sites->sortByDesc('created_at') as $site)
                                                            <option value="{{ $site->id }}" >{{ $site->name_fr }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse1_en" value="1" name="correcte_en"class="custom-control-input" wire:model="correcte_en" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse2_en"  value="2" name="correcte_en"class="custom-control-input" wire:model="correcte_en"   >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse3_en"  value="3" name="correcte_en"class="custom-control-input" wire:model="correcte_en" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse4_en"  value="4" name="correcte_en"class="custom-control-input" wire:model="correcte_en"   >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="correcte_fr" value="1" name="correcte_fr"class="custom-control-input" wire:model="correcte_fr" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse2_fr" value="2" name="correcte_fr"class="custom-control-input" wire:model="correcte_fr" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse3_fr" value="3" name="correcte_fr"class="custom-control-input" wire:model="correcte_fr" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="reponse4_fr" value="4" name="correcte_fr"class="custom-control-input" wire:model="correcte_fr" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="correcte2_ar" name="correcte_ar" class="custom-control-input" value="2" wire:model="correcte_ar"   >
                                                                            <label    class="custom-control-label"  for="correcte2_ar"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <input type="text" placeholder="أدخل  الجواب 2 هنا" wire:model="reponse2_ar" class="form-control" aria-label="Text input with radio button">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="correcte3_ar" name="correcte_ar" class="custom-control-input" value="3" wire:model="correcte_ar" >
                                                                            <label class="custom-control-label" for="correcte3_ar"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="أدخل  الجواب 3 هنا"  wire:model="reponse3_ar" aria-label="Text input with radio button" >
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-radio"> 
                                                                            <input type="radio" id="correcte4_ar" name="correcte_ar" class="custom-control-input" value="4" wire:model="correcte_ar"   >
                                                                            <label    class="custom-control-label"  for="correcte4_ar"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <input type="text" placeholder="أدخل  الجواب 4 هنا"  wire:model="reponse4_ar" class="form-control" aria-label="Text input with radio button">
