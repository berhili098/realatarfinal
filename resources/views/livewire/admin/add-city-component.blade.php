                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-4 offset-md-1   text-center ">
                                        ...
                                        @else
                                            ...
                                            @enderror
                                        @endif
                                        <input type="file" id="uploadfile" class="custom-file-input" wire:model="photo" accept="image/*" >
                                    </div>
                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input input type="text" id="latitude" class="form-control" wire:model.lazy="latitude" placeholder="5.698069809">
                                                    </div>
                                                    @error('latitude')
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input input type="text" id="latitude" class="form-control" id="longitude"
                                                        wire:model.lazy="longitude" placeholder="5.698069809">
                                                    </div>
                                                    @error('longitude')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="city_en"
                                                                    wire:model.lazy="city_en" placeholder="Enter name of the city ">
                                                                @error('city_en')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="description_en" rows="7" class="form-control" wire:model.lazy="description_en" placeholder="Enter city's description in english"></textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="city_fr"
                                                                    wire:model.lazy="city_fr" placeholder="Entrez le nom de la ville">
                                                                @error('city_fr')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="description_fr" rows="7" class="form-control" wire:model.lazy="description_fr" placeholder="Entrez la description de la ville en anglais "></textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="city_ar"
                                                                    wire:model.lazy="city_ar" placeholder="أدخل اسم المدينة">
                                                                @error('city_ar')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="description_ar" rows="7" class="form-control" wire:model.lazy="description_ar" placeholder="أدخل وصف المدينة باللغة العربية"></textarea>
