                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('primary/assets/images/logo-icon.png') }}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{ asset('primary/assets/images/logo-light-icon.png') }}" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="primary/assets/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="primary/assets/images/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="primary/assets/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('form-logout').submit();" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
                    ...
                    <ul id="sidebarnav">
                        <li class="user-pro"> 
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <img src="{{ asset('primary/assets/images/users/1.jpg') }}" alt="user-img" class="img-circle">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('form-id').submit();"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="realestate-property-4-column.html"><i class="ti-layout"></i><span class="hide-menu">Property 4 Column</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="realestate-property-detail.html"><i class="ti-check-box"></i><span class="hide-menu">Property Detail</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="realestate-add-property.html"><i class="ti-support"></i><span class="hide-menu">Add Property</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="primary/documentation/documentation.html" aria-expanded="false"><i class="far fa-circle text-danger"></i><span class="hide-menu">Documentation</span></a></li>
